...
<head>
  ...
  <title>OkularYönetim Paneli Eğitim Sürümü </title>
    ...
    <div class="login_wrapper">
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../dynamic/islem.php" method="POST">
            ...
            <div class="separator">
             ...
             if ($_GET['durum']=="no") {?>
             <b style="color:red"> <?php echo "Kayıt Bulunamadı....";?></b>
             ...
             echo "Başarıyla Çıkış Yaptınız.";
              ...
              <div>
                <h1><i class="fa fa-paw"></i> Okular</h1>
                <p>©Yavuz Yarkın Okular</p>
              </div>
            </div>
          </form>
